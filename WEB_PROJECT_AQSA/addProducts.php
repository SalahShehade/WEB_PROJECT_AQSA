...
if(isset($_POST['submit'])){
			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg") && $type == "image/jpeg" && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						$sql2 = "INSERT INTO products (pro_name, cat_id, pro_price, pro_desc, pro_thumb)
    ...
    $sql = "INSERT INTO products (pro_name, cat_id, pro_price, pro_desc, pro_thumb)     VALUES ('$productname', '$productcategory', '$productprice', '$productdescription' )";
