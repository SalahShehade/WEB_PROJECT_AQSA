...
<div class="wrapper" id="app">
    <div class="card-form">
      ...
      <div class="card-form__inner">
        ...
        <form method="post">
        <button type="submit" name="subpaybtn" class="card-form__button">
          Submit
        </button>
      </form>
...
<script src='https://unpkg.com/vue-the-mask@0.11.1/dist/vue-the-mask.js'></script><script  src="./scriptpay.js"></script>
