...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="Admin.php">Al-Aqsa Home</a>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="categories.php">عرض الأصناف</a>
          <a class="dropdown-item" href="addCategory.php">إضافة صنف</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="Products+.php">عرض المنتجات </a>
          <a class="dropdown-item" href="addProducts.php">إضافة منتج</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">عرض الطلبات</a>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">تعديل الحساب </a>
