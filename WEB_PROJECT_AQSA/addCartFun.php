...
//    $sql = "INSERT INTO cart (cart_name, cart_price, cart_image)
//    VALUES ('?', '?', '?')";
...
function addfun($cartname,$cartimg,$cartprice,$quantity){

    $sql = "INSERT INTO cart (cart_name, cart_price, cart_image)
    VALUES ('$cartname', '$cartimg', '$cartprice',)";
